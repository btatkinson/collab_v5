...
get_header(); ?>
<div class="ab-bkgrd">
    <!-- EDITS TOP PART (JUMBOTRON) -->
    <div class="gs-container">
    <div class="row align-items-center">
    <div class="col-lg-12">
    <div class="jumbotron gs-jumbotron">
    <h1 class="gs-display">Where Do I Start?</h1>

    <hr class="my-4" />

    <ul>
        <li class="lead">You can begin the Collaborative Process by contacting any of our Collaborative Professionals. They will explain how the Collaborative Process works and help you assemble your team of caring professionals.</li>
        <li class="lead">Many people begin by contacting a Family Lawyer. You can start by contacting any Collaborative Professional based on what you feel you need. If your immediate concerns involve finances, you might choose to contact a Financial Specialist. Or, if you're struggling with emotions, conflict, or parenting issues, you might choose to contact a Family Relations Specialist.</li>
        <li class="lead">If you're not sure yet whether the Collaborative Process is the right fit for you, reach out to any of our Collaborative Professionals. We know this is a stressful time and we will be happy to answer your questions.</li>
    </ul>
    </div>
    </div>
    </div>
    ...
    &nbsp;
    <h6 class="d-lg-block d-md-none d-xs-none d-sm-none">Attorney</h6>
    &nbsp;
    ...
    &nbsp;
    <h6 class="d-lg-block d-md-none d-xs-none d-sm-none">Family Relations Specialist</h6>
    &nbsp;
    ...
    &nbsp;
    <h6 class="d-lg-block d-md-none d-xs-none d-sm-none">Financial Specialist</h6>
    &nbsp;
    ...
    <h2 class="">Financial Specialist</h2>
    ...
    <h2 class="">Family Relations Specialist</h2>
