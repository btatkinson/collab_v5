...
<div class="container">
  <div class="row">
    <div class="col ab-title">
      <h1 class="text-center ab-display"><?php single_post_title(); ?></h1>
    </div>
  </div>
  <div class="row ab-row">
    <div class="col-lg-4 d-xs-none d-sm-none d-md-none d-lg-block">
      <div class="ab-image" style="height: 100%; background-image: url(<?php echo get_theme_mod('_themename_about_image_first'); ?>);
  ...
  <div class="row ab-row">
    <div class="col-lg-7 ab-col">
      <div class="about-block">
        <h5 class="eyebrow"></h5>
        <h2>What will my Collaborative Process look like?</h2>
        <p>
    ...
    <div class="col-lg-5 ab-col d-xs-none d-sm-none d-lg-block">
      <div class="ab-image" style="height: 50%; background-image: url(<?php echo get_theme_mod('_themename_about_image_second'); ?>);
        background-position: center;
        background-repeat: no-repeat;
        background-size: cover;">
      </div>
      <br>
      <br>
      <div class="ab-image" style="height: 40%; background-image: url(<?php echo get_theme_mod('_themename_about_image_third'); ?>);
        background-position: center;
        background-repeat: no-repeat;
        background-size: cover;">
      </div>
  ...
  <div class="row">
    <div class="col">
      <div class="ab-image-bottom" style="height: 300px; background-image: url(<?php echo get_theme_mod('_themename_about_image_fourth'); ?>);
        background-position: center;
        background-repeat: no-repeat;
        background-size: cover;">
    ...
    <!-- <div class="ab-image" style="height: 100%; background-image: url(' . esc_html($image_url) . ');
      background-position: center;
      background-repeat: no-repeat;
      background-size: cover;">
    </div> -->
